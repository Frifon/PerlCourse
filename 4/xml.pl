...
my $doc = $parser->parse_file('xmlin');
my $root = $doc->documentElement();
my @nodeList = $doc->getElementsByTagName('book');
foreach my $book (@nodeList) {
    my $bookContent = $book->textContent;
    my $parent = $book->parentNode;
    say '===';
    say $book;
    say '===';
    say $bookContent;
